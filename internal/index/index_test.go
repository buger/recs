...
// MCDC INT-REQ-260820-2JKK: canonical_state_mutated=T, index_files_rewritten=T, index_rebuild_requested=F, record_count_GE_0=T, store_records_scanned=T => TRUE
...
//mcdc:ignore SW-REQ-260820-BNR7: canonical_state_mutated=F, index_is_canonical=F, index_rebuild_requested=T, index_rebuilt_from_records=F, record_count_GE_0=T, store_records_scanned=T => FALSE -- correct implementation never produces this guarantee-violation assignment [reviewed: agent:grok] [category: defensive]
//mcdc:ignore SW-REQ-260820-BNR7: canonical_state_mutated=F, index_is_canonical=F, index_rebuild_requested=T, index_rebuilt_from_records=T, record_count_GE_0=T, store_records_scanned=F => FALSE -- correct implementation never produces this guarantee-violation assignment [reviewed: agent:grok] [category: defensive]
// MCDC SW-REQ-260820-BNR7: canonical_state_mutated=F, index_is_canonical=F, index_rebuild_requested=T, index_rebuilt_from_records=T, record_count_GE_0=T, store_records_scanned=T => TRUE
//mcdc:ignore SW-REQ-260820-BNR7: canonical_state_mutated=F, index_is_canonical=T, index_rebuild_requested=T, index_rebuilt_from_records=T, record_count_GE_0=T, store_records_scanned=T => FALSE -- correct implementation never produces this guarantee-violation assignment [reviewed: agent:grok] [category: defensive]
//mcdc:ignore SW-REQ-260820-BNR7: canonical_state_mutated=T, index_is_canonical=F, index_rebuild_requested=T, index_rebuilt_from_records=T, record_count_GE_0=T, store_records_scanned=T => FALSE -- correct implementation never produces this guarantee-violation assignment [reviewed: agent:grok] [category: defensive]
// MCDC SW-REQ-260820-BNR7: canonical_state_mutated=T, index_is_canonical=T, index_rebuild_requested=F, index_rebuilt_from_records=T, record_count_GE_0=T, store_records_scanned=T => TRUE
// MCDC SW-REQ-260820-BNR7: canonical_state_mutated=T, index_is_canonical=T, index_rebuild_requested=T, index_rebuilt_from_records=T, record_count_GE_0=F, store_records_scanned=T => TRUE
//mcdc:ignore SW-REQ-260820-BNR7: canonical_state_mutated=T, index_is_canonical=T, index_rebuild_requested=T, index_rebuilt_from_records=T, record_count_GE_0=T, store_records_scanned=T => FALSE -- correct implementation never produces this guarantee-violation assignment [reviewed: agent:grok] [category: defensive]
// MCDC SYS-REQ-260820-0TQX: context_rejected=F, context_requested=F, related_records_assembled=F, relation_count_GE_0=T, relations_resolved=F, seed_record_loaded=F => TRUE
...
// MCDC SYS-REQ-260820-Q8GR: index_is_canonical=F, index_rebuild_requested=T, index_rebuilt_from_records=T, record_count_GE_0=T => TRUE
// MCDC SYS-REQ-260820-Q8GR: index_is_canonical=T, index_rebuild_requested=F, index_rebuilt_from_records=T, record_count_GE_0=T => TRUE
// MCDC SYS-REQ-260820-Q8GR: index_is_canonical=T, index_rebuild_requested=T, index_rebuilt_from_records=T, record_count_GE_0=F => TRUE
