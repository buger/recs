...
// MCDC SW-REQ-260820-MQF2: attachments_dir_created=F, boards_dir_created=F, crm_yaml_written=F, derived_dirs_created=F, inbox_dir_created=F, init_command_invoked=F, parse_budget_GE_0=T, records_dir_created=F, templates_dir_created=F, workspace_dir_count_GE_8=F => TRUE [no-action: SW-REQ-260820-MQF2ActionCalls == 0]
...
// MCDC SYS-REQ-260820-KJ34: attachments_dir_created=F, boards_dir_created=F, crm_yaml_written=F, derived_dirs_created=F, inbox_dir_created=F, init_command_invoked=F, parse_budget_GE_0=T, records_dir_created=F, templates_dir_created=F, workspace_dir_count_GT_0=F => TRUE [no-action: SYS-REQ-260820-KJ34ActionCalls == 0]
...
// MCDC SW-REQ-260820-N02Y: create_rejected=F, frontmatter_sep_index_GE_3=F, frontmatter_written=F, markdown_body_written=F, parse_budget_GE_0=T, record_create_requested=F, record_id_assigned=F, record_type_stored=F => TRUE [no-action: SW-REQ-260820-N02YActionCalls == 0]
...
// MCDC SW-REQ-260820-Q3C4: atomic_rename_completed=F, conflict_reported=F, frontmatter_sep_index_GE_3=F, frontmatter_updated=F, mutation_rejected=F, parse_budget_GE_0=T, record_mutation_requested=F, temp_file_written=F, version_mismatch=F => TRUE [no-action: SW-REQ-260820-Q3C4ActionCalls == 0]
...
// MCDC SYS-REQ-260820-2SQZ: atomic_rename_completed=F, conflict_reported=F, frontmatter_sep_index_GE_0=F, frontmatter_updated=F, mutation_rejected=F, parse_budget_GE_0=T, record_mutation_requested=F, temp_file_written=F, version_mismatch=F => TRUE [no-action: SYS-REQ-260820-2SQZActionCalls == 0]
...
// MCDC SYS-REQ-260820-9J7C: create_rejected=F, frontmatter_sep_index_GE_0=F, frontmatter_written=F, markdown_body_written=F, parse_budget_GE_0=T, record_create_requested=F, record_id_assigned=F, record_type_stored=F => TRUE [no-action: SYS-REQ-260820-9J7CActionCalls == 0]
...
// MCDC INT-REQ-260820-JRWN: board_move_committed=F, column_list_len_GT_0=T, matcher_depth_GE_0=T, record_file_relocated=T, store_frontmatter_write_used=T => TRUE [no-action: INT-REQ-260820-JRWNActionCalls == 0]
...
// MCDC SW-REQ-260820-9C5Z: folder_relocation_required=F, frontmatter_status_updated=F, frontmatter_updated=F, record_status_changed=F => TRUE [no-action: SW-REQ-260820-9C5ZActionCalls == 0]
...
// MCDC SW-REQ-260820-EX7Q: column_known=F, column_list_len_GT_0=F, column_list_len_LE_64=F, file_path_unchanged=F, frontmatter_field_updated=F, matcher_depth_GE_0=T, move_rejected=F, move_requested=F => TRUE [no-action: SW-REQ-260820-EX7QActionCalls == 0]
...
// MCDC SYS-REQ-260820-7WT4: folder_relocation_required=F, frontmatter_status_updated=F, record_status_changed=F => TRUE [no-action: SYS-REQ-260820-7WT4ActionCalls == 0]
...
// MCDC SYS-REQ-260820-BVBE: column_known=F, column_list_len_GT_0=F, file_path_unchanged=F, frontmatter_field_updated=F, matcher_depth_GE_0=T, move_rejected=F, move_requested=F => TRUE [no-action: SYS-REQ-260820-BVBEActionCalls == 0]
