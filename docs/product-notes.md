<!-- Original 2026-08-20 design notes. The current product README is ../README.md. -->

# Original product notes

These are the first 50 sections that started the repo. The binary and workspace grew past a customer-only CRM. Keep this file as history, not as the on-ramp.
...
Later dropped: Cosmopolitan / APE is a permanent non-goal. Ship only the native Go binary from `go build`.
